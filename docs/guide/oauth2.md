...
Aplikasi Android menggunakan library [AppAuth](https://github.com/openid/AppAuth-Android)
...
| Parameter | Nilai |
|---|---|
| Authorization endpoint | `{serverUrl}/oauth/authorize` |
| Token endpoint | `{serverUrl}/oauth/token` |
| Redirect URI | `com.example.timestudy://callback` |
